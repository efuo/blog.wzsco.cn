...
![效果](https://p.wzsco.top//0c58ba4f87fd089bd6887e2e4396b3b6.png/blogimg)
...
{% fold v1教程，已弃用 %}
   ...
   2. 获取Key、经度、纬度
      ...
      ![注册腾讯地图开发者账号](https://p.wzsco.top//ea2c2491aa8bacef5af09350f176af38.png/blogimg)
      创建应用，名字随意，类型选其他。[点击前往](https://lbs.qq.com/console/mykey.html)。
      ![创建应用](https://p.wzsco.top//e05e9c696261a348faa680007515fd51.png/blogimg)
      创建Key，名字随意，类型选 <strong>WebServiceAPI</strong>，白名单写自己的域名（只需要顶级域名即可）。
      ![添加key](https://p.wzsco.top//a07670c7856823dc50e8ed273586a6bb.png/blogimg)
      ![信息参考](https://p.wzsco.top//70c38c28f5c62594688851a953514e9c.png/blogimg)
      还需在配额页面，将 <strong>IP定位</strong> 配置调用次数。
      ![配额页面](https://p.wzsco.top//6dd9ad18b56e37152d418901f91130ef.png/blogimg)
      获取经纬度，[点击前往](https://lbs.qq.com/tool/getpoint/index.html)。
      ![搜索自己的位置坐标，在右侧复制经（左）纬（右）度](https://p.wzsco.top//4ed63d30ed67baa179f320f59acd3f50.png/blogimg)
